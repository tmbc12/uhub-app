  ...
  return (
    <div className=" flex  max-md:max-w-full ">
      <div className=" mt-3.5 mb-10 w-full  max-md:max-w-full">
        <div className="  flex max-md:flex-col max-md:gap-0 bg-slate-100 justify-center ">
          <div className=" xl:pl-44  flex flex-col max-md:ml-0 max-md:w-full max-sm:px-5 sm:p-6">
            <div className=" md:pl-16 lg:pl-10  flex flex-col max-md:mt-2 max-md:max-w-full">
              <div className="max-md:max-w-full fade-up">
                <div className="flex gap-5 max-md:flex-col max-md:gap-0">
                  <div className="flex flex-col w-[72%] mt-16 max-md:ml-0 max-md:w-full">
                    <div className="flex flex-col grow mt-3 max-md:mt-10 max-md:max-w-full">
                      <h1 className="text-5xl font-bold tracking-tighter leading-[57px] text-neutral-800 max-md:max-w-full max-md:text-4xl max-md:leading-[51px] fade-up">
              ...
              <div className="flex mt-10 gap-5 max-w-full text-7xl font-bold leading-[116px] text-zinc-500 w-[247px] max-md:text-4xl max-md:leading-[68px] fade-up">

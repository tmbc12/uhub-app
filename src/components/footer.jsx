...
const footer = () => {
  return (
    <div className="  flex flex-col mt-28 w-full max-md:mt-10 max-md:max-w-full items-center ">
      <div className=" container flex  gap-5 justify-between items-start px-5 text-sm font-medium tracking-normal text-slate-600  max-md:max-w-full max-sm:flex-col">
        <img
          loading="lazy"
          srcSet={logo}
          alt="logo"
        ...
        />
        <div className=" grid grid-cols-5 lg:grid-cols-4 max-sm:grid-cols-2 md:grid-cols-3 sm:grid-cols-3 gap-20 "> 

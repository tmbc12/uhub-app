        ...
        <div className=' flex items-center justify-center max-sm:-mt-5'>
            <div className=" container p-20 bg-white max-md:px-5">
                ...
                <div className="flex justify-between items-center gap-5 max-md:gap-0">
                    ...
                    <div className=' absolute xl:mt-[500px] md:hidden lg:block max-sm:hidden sm:hidden lg:mt-[200px]'>
                        ...
                        <div className=" flex flex-col xl:ml-14 items-start py-7 pr-10 pl-8 max-w-full bg-white rounded-lg border border-amber-500 border-solid shadow-lg lg:w-[425px] max-md:px-5 lg:ml-0 max-md:w-[380px]">

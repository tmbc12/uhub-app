    ...
    return (
        <div className=' flex items-center justify-center'>
            <div className=" container p-20 bg-white max-md:px-5">
                <div className=" absolute -ml-40 px-12 py-7 mt-8 max-w-full bg-white rounded-lg border border-amber-500 border-solid shadow-lg w-[430px] max-md:px-5">
                    <div className="flex gap-5 max-md:flex-col max-md:gap-0">
                        <div className="flex flex-col max-md:ml-0 max-md:w-full">
                            <img
                                loading="lazy"
                                srcSet={schedule}
                                className="shrink-0 mx-auto rounded-full border-2 border-solid aspect-square bg-slate-200 border-slate-300 w-16 p-3  stroke-[1.5px]  max-md:mt-10"
                            />
                        </div>
                ...
                <div className="flex justify-between items-center gap-5 max-md:flex-col max-md:gap-0">
                    <div className="flex flex-col w-[40%] max-md:ml-0 max-md:w-full">
                        ...
                        />
                        <div className=" absolute top-[580px] ml-36 flex z-10 justify-center items-center self-center px-4 mt-11 rounded-full border-2 border-white border-solid bg-indigo-950 h-[60px] stroke-[2px] w-[60px] max-md:mt-10">
                            <img
                                loading="lazy"
                    ...
                    <div className=" absolute flex flex-col ml-12 items-start py-7 pr-20 pl-8 max-w-full bg-white rounded-lg border border-amber-500 border-solid shadow-lg w-[425px] max-md:px-5">
